    ...
    return (
        <div className="min-h-screen bg-slate-900 pt-24 md:pt-28 pb-12 relative overflow-hidden">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-purple-500/19 rounded-full blur-3xl"></div>
                <div className="absolute bottom-1/3 right-1/4 w-[480px] h-[480px] bg-blue-500/18 rounded-full blur-3xl"></div>
                <div className="absolute top-1/2 left-1/3 w-96 h-96 bg-c2air-accent/20 rounded-full blur-3xl"></div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed font-light">
                        Connect with us across our social platforms. Join conversations, stay updated, and be part of the C2AIR community.
                    </p>
                </div>
                <div className="mb-16">
                    ...
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                        <a
                            ...
                            className="group relative bg-gradient-to-br from-green-500/10 to-green-600/5 border-2 border-green-500/30 rounded-2xl p-8 hover:border-green-500/60 hover:bg-green-500/15 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-green-500/20"
                        >
                            <div className="flex flex-col items-center text-center">
                                ...
                                <div className="mt-4 text-green-400 font-medium text-sm flex items-center gap-2">
                                    Join Now
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-gray-400 text-sm md:text-base">
                                    Connect with us on Telegram for community updates and discussions
                                </p>
                                <div className="mt-4 text-blue-400 font-medium text-sm flex items-center gap-2">
                                    Join Now
                                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                ...
                <div>
                    ...
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="group bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-c2air-accent/50 hover:bg-slate-800/50 transition-all duration-300 hover:scale-105"
                        >
                            <div className="flex flex-col items-center text-center">
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div className="w-12 h-12 bg-black/40 rounded-lg flex items-center justify-center mb-3 group-hover:bg-black/60 transition-colors">
                        ...
                        >
                            <div className="flex flex-col items-center text-center">
                                <div className="w-12 h-12 bg-pink-500/20 rounded-lg flex items-center justify-center mb-3 group-hover:bg-pink-500/30 transition-colors">
